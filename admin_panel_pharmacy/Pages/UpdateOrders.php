...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
                    ...
                    <div class="col-md-8 mb-4">
                        <div class="card mb-4">
                            <div class="card-header py-3">
                                <h3 class="mb-0 text-center">Order Detail</h3>
                            </div>
                            <div class="card-body">
                                <form onsubmit="return false;">
                                    ...
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form6Example4">Customer Name</label>
                                        <input type="text" name="name" id="name" class="form-control" required />
                                    </div>
                                    ...
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form6Example4">latitude</label>
                                        <input type="text" name="latitude" id="latitude" class="form-control"
                                            required />
                                    </div>

                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form6Example4">longitude</label>
            ...
            var userid = decodeURIComponent(window.location.search);
            var queryString = userid.substring(8);
            let ref = firebase
                .database()
                .ref("Pills/Orders")
                .orderByChild("id")
                ...
                .then(function(snapshot) {
                    if (snapshot.exists()) {
                        snapshot.forEach(function(data) {
                            ...
                            //   document.getElementById("data").innerText = name + " Data";


                        });
                    } else {
                        window.alert("Causing Error! Refresh it");
                    }
            ...
            $("#update").click(function() {
                ...
                let ref = firebase.database()
                    ...
                    .update({
                        ...
                        window.alert("Success:The Order Detail has Updated");
