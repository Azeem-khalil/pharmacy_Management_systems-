                ...
                <div class="col-md-8 mb-4">
                    <div class="card mb-4">
                        <div class="card-header py-3">
                            <h3 class="mb-0 text-center">Update Pharmacies</h3>
                        </div>
                        <div class="card-body">
                            <form onsubmit="return false;">
                                ...
                                <div class="form-check d-flex justify-content-center mb-2">
                                    <input type="button" value="submit" name="update" id="update"
            ...
            .then(function(snapshot) {
                if (snapshot.exists()) {
                    snapshot.forEach(function(data) {
                        ...
                        var Address1 = data.val().Address1;
                        var Address2 = data.val().Address2;
                        var country = data.val().country;
                        var phoneNumber = data.val().number;
        ...
        $("#update").click(function() {
            ...
            let ref = firebase.database()
                ...
                .update({
                    ...
                    window.alert("Success:The Pharmacies Detail has Updated");
                    window.location.href = "./pharmaciesData.php";
