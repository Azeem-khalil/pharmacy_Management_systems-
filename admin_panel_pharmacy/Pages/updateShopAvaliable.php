                    ...
                    <div class="col-md-8 mb-4">
                        <div class="card mb-4">
                            <div class="card-header py-3">
                                <h3 class="mb-0 text-center">Shop Avaliable</h3>
                            </div>
                            <div class="card-body">
                ...
                .then(function(snapshot) {
                    if (snapshot.exists()) {
                        snapshot.forEach(function(data) {
                            var latitude = data.val().lat;
                            var longitude = data.val().lng;
            ...
            $("#update").click(function() {
                ...
                let ref = firebase.database()
                    ...
                    .update({
                        ...
                        window.alert("Success:The Shop Detail has Updated");
