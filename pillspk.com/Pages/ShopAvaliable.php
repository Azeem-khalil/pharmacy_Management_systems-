...
<body class="sb-nav-fixed" onload="FetchAllUsers()">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                <h1 class="text-center text-primary">Shop Availabile</h1>
            ...
            function FetchAllUsers() {
                var database = firebase.database().ref("Pills").child("ShopAvailable");
                database.once("value", function(snapshot) {
                    if (snapshot.exists()) {
                        ...
                        snapshot.forEach(function(data) {
                            ...
                            content += "<tr>";
                            content += "<td>" + lat + "</td>"; //column1
                            content += "<td>" + lng + "</td>"; //column2
                        ...
                        $(document).on("click", ".hero", function() {
                            if (
                                ...
                                firebase
                                    .database()
                                    .ref("Pills/ShopAvailable/" + ids)
                                    .remove();
                                window.location.href = "./shopAvaliable.php";
                            } else {
                        ...
                        $(document).on("click", ".update", function() {
                            ...
                            //   .ref("Pills/user/" + ids)
                            //   .remove();
                            window.location.href = "./updateShopAvaliable.php?userid=" + ids;
                        });
                    }
                });
            }
