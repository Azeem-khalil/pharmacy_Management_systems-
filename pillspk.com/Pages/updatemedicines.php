        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="row">
                    ...
                    <input type="file" id="files" name="files[]" accept="image/*" class="form-control-file"
                ...
                .then(function(snapshot) {
                    if (snapshot.exists()) {
                        snapshot.forEach(function(data) {
                            ...
                            var discription = data.val().discription;
                            ...
                            //   document.getElementById("files").value = image;
            ...
            $("#update").click(function() {
                ...
                let ref = firebase.database()
                    ...
                    .update({
                        ...
                        window.alert("Success:The Medicines  Detail has Updated");
