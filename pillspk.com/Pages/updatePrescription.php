                    ...
                    <div class="col-md-8 mb-4">
                        <div class="card mb-4">
                            <div class="card-header py-3">
                                <h3 class="mb-0 text-center">Prescription Details</h3>
                            </div>
                            <div class="card-body">
                                <form onsubmit="return false;">
                                    ...
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form6Example4">Prescription name</label>
                                        <input type="text" name="name" id="name" class="form-control" required />
                                    </div>
            ...
            $("#update").click(function() {
                ...
                let ref = firebase.database()
                    ...
                    .update({
                        ...
                        window.alert("Success:The Prescription Detail has Updated");
