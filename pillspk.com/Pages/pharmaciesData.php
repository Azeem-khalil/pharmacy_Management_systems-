...
<body class="sb-nav-fixed" onload="FetchAllUsers()">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                <h1 class="text-center text-primary">Pharmacy Data</h1>
                <table class="table  table-dark  table-responsive  table-dark  table-white table-striped table-bordered"
                    id="ex-table">
                    <thead>
                        <tr>
            ...
            function FetchAllUsers() {
                var database = firebase.database().ref("Pills").child("pharmcies");
                    ...
                    if (snapshot.exists()) {
                        ...
                        $(document).on("click", ".hero", function() {
                            if (
                                ...
                                firebase
                                    .database()
                                    .ref("Pills/pharmcies/" + ids)
                                    .remove();
                                window.location.href = "./pharmacies.php";
                            } else {
