...
<body class="sb-nav-fixed" onload="FetchAllUsers()">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                <h1 class="text-center text-primary">CANCEL ORDER </h1>
                ...
                database.once("value", function(snapshot) {
                    if (snapshot.exists()) {
                        ...
                        $(document).on("click", ".orderdetail", function() {
                            ...
                            window.location.href = "./cancel_order_detail.php?orderid=" + ids;
                        ...
                        $(document).on("click", ".deleteOrder", function() {
                            if (
                                ...
                                firebase
                                    .database()
                                    .ref("Pills/-MwWypM8lxNs85MqWsXB/CancelOrder/" + ids)
                                    .remove();
                                window.location.href = "./cancel Orders.php";
                            } else {
