...
<body class="sb-nav-fixed" onload="FetchAllUsers()">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                <h1 class="text-center text-primary">Medicines</h1>
                <table class="table   table-dark table-responsive  table-white table-striped table-bordered"
                    id="ex-table">
                    <thead>
                        <tr>
            ...
            function FetchAllUsers() {
                var database = firebase.database().ref("Pills").child("Medicines/");
                ...
                database.once("value", function(snapshot) {
                    if (snapshot.exists()) {
                        ...
                        snapshot.forEach(function(data) {
                            ...
                            var storageRef = firebase.storage().ref("Pills");
                            ...
                            storageRef
                                ...
                                .then(function(result) {
                                    result.items.forEach(function(ImageReference) {
                                        console.log(ImageReference.toString());
                                        DisplayImage(ImageReference, Image);
                                    });
                                });

                            function DisplayImage(ImageReference, Image) {
                                ImageReference.child("Medicines/" + Image)
                                    .getDownloadURL()
                                    .then(function(url) {
                                        var test = url;
                                        console.log(test);
                        ...
                        // content +=
                        //   "<td>" +
                        //   "<img  id='id'  height='50px' width='50px'   alt='new image' >" +
                        //   "</td>";
                        ...
                        $(document).on("click", ".update", function() {
                            ...
                            //   .ref("Pills/user/" + ids)
                            //   .remove();
                            window.location.href = "./updatemedicines.php?userid=" + ids;
                        });
                    }
                });
            }
